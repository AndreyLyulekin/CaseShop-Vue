  ...
  <header class="header" id="header" v-cloak>
   <div class="header__parts">
     ...
     <div class="header__right-part">
       ...
       <svg xmlns="http://www.w3.org/2000/svg" width="19.229" height="22.289" viewBox="0 0 19.229 22.289"><path fill="#fff" fill-rule="evenodd" d="M13.3-135.374a8.493,8.493,0,0,1-5.833,1.368l-.014,0h0A8.549,8.549,0,0,1,.072-143.58a8.549,8.549,0,0,1,9.572-7.376,8.549,8.549,0,0,1,7.376,9.572l0,.014v0a8.493,8.493,0,0,1-2.9,5.367l5.107,6.628-.817.63Zm2.8-6.953a7.548,7.548,0,0,0-6.573-7.614,7.546,7.546,0,0,0-8.449,6.511,7.548,7.548,0,0,0,5.675,8.293,7.627,7.627,0,0,0,.817.151,7.563,7.563,0,0,0,8.468-6.525A7.662,7.662,0,0,0,16.1-142.327Z" transform="translate(0 151.028)"></path></svg>
